  ...
  return (  
    <div>
      <div className="pt-[7rem] md:pt-[6rem] mx-auto max-w-[1400px] md:px-4">
        <h2 className="text-white font-medium text-[2rem] mb-[1rem] mx-4 md:mx-8  border-l-[10px] pl-2 border-red-600 ">Results for {searchTerm.charAt(0).toUpperCase() + searchTerm.slice(1)}</h2>
